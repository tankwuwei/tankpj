 ...
 */
@Controller
public class CenterServerConntor extends ConnectBaseSession {
	// 采样频率
	...
	protected void onDisconnect() {
		LogUtil.debug("disconnect from monitor system!");
		doLink();
	}

	@Override
	protected void onConnect() {
		LogUtil.debug("connect to monitor system!");
		sampleTime = 0;
	}
